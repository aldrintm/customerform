  ...
  try {
    ...
    const customerDoc = await Customer.findById(id, {
      ...
      .populate({
        path: 'projects',
        select:
          'status customerType storeId description materialType materialThickness materialBrand materialColor materialFinish edge sinkQuantity sinkType sinkLocation sinkInfo stove splash cooktop notes schedules purchaseOrders',
        populate: {
          path: 'schedules',
          model: 'Schedule',
          select:
