...
const LoginComponent = () => {
  ...
  return (
    <div className='mx-auto max-w-screen-md px-4 py-20 md:py-36'>
      ...
      {/* Google Button */}
      <div className='flex items-center justify-center max-w-md mx-auto mt-4 bg-white dark:bg-gray-900 border border-gray-300 rounded-md shadow-md px-8 py-3 text-base font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500'>
        <div className=''>
