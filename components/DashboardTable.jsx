                    ...
                    <td className='whitespace-nowrap px-0 py-0 text-sm'>
                      ...
                      >
                        {customer.projects?.[0]?.status === 'will call' ? (
                          <div className='px-2 py-1 text-center md:text-sm bg-green-100 text-green-500 rounded-full'>
                            will call
                          </div>
                          ...
                          <div className='px-2 py-1 text-center md:text-sm bg-slate-100 text-slate-500 rounded-full'>
                            hold
                          </div>
                          ...
                          <div className='px-2 py-1 text-center md:text-sm bg-indigo-100 text-indigo-500 rounded-full'>
                            service
                          </div>
